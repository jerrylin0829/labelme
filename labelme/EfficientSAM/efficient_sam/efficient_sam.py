...
class EfficientSam(nn.Module):
    ...
    def forward(
        ...
        batched_points: torch.Tensor,
        batched_point_labels: torch.Tensor,
        max_queries_per_batch: int = 200,  #! New para.
        ...
        initial_memory_allocated = torch.cuda.memory_allocated("cuda")
        initial_memory_reserved = torch.cuda.memory_reserved("cuda")
        ...
        final_memory_allocated = torch.cuda.memory_allocated("cuda")
        final_memory_reserved = torch.cuda.memory_reserved("cuda")
        ...
        gpu_utilization = torch.cuda.utilization("cuda")
